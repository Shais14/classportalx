...
class UserHistoriesControllerTest < ActionController::TestCase
  ...
  test "should create user_history" do
    assert_difference('UserHistory.count') do
      post :create, user_history: { action: @user_history.action, course_id: @user_history.course_id, user_id: @user_history.user_id }
    end
  ...
  test "should update user_history" do
    patch :update, id: @user_history, user_history: { action: @user_history.action, course_id: @user_history.course_id, user_id: @user_history.user_id }
    assert_redirected_to user_history_path(assigns(:user_history))
  end
